...
Skyboxes = {
	...
	["Vaporwave"] = {
		["SkyboxBk"] = "rbxassetid://1522880011",
		["SkyboxDn"] = "rbxassetid://1522879555",
		["SkyboxFt"] = "rbxassetid://1522881267",
		["SkyboxLf"] = "rbxassetid://1522880456",
		["SkyboxRt"] = "rbxassetid://1522880795",
		["SkyboxUp"] = "rbxassetid://1522881519"
	},
	["Anime Sky"] = {
		["SkyboxBk"] = "rbxassetid://3414902120",
		["SkyboxDn"] = "rbxassetid://3414901584",
		["SkyboxFt"] = "rbxassetid://3414903332",
		["SkyboxLf"] = "rbxassetid://3414902500",
		["SkyboxRt"] = "rbxassetid://3414902914",
		["SkyboxUp"] = "rbxassetid://3414903738"
	},
	["Retrowave"] = {
		["SkyboxBk"] = "rbxassetid://3151817348",
		["SkyboxDn"] = "rbxassetid://3151816982",
		["SkyboxFt"] = "rbxassetid://3151818165",
		["SkyboxLf"] = "rbxassetid://3151817637",
		["SkyboxRt"] = "rbxassetid://3151817887",
		["SkyboxUp"] = "rbxassetid://3151818451"
	},
	["Cyberpunk"] = {
		["SkyboxBk"] = "rbxassetid://4637153724",
		["SkyboxDn"] = "rbxassetid://4637153922",
		["SkyboxFt"] = "rbxassetid://4637154093",
		["SkyboxLf"] = "rbxassetid://4637154245",
		["SkyboxRt"] = "rbxassetid://4637154438",
		["SkyboxUp"] = "rbxassetid://4637154593"
	},
	["Cartoon Day"] = {
		["SkyboxBk"] = "rbxassetid://5538210354",
		["SkyboxDn"] = "rbxassetid://5538211603",
		["SkyboxFt"] = "rbxassetid://5538209804",
		["SkyboxLf"] = "rbxassetid://5538206129",
		["SkyboxRt"] = "rbxassetid://5538208750",
		["SkyboxUp"] = "rbxassetid://5538211059"
	}
}
local L_60_ = {
	SmoothPlastic = "",
...
skySection:AddToggle({
	...
	max = 6,
	values = { "Game's Sky", "Purple Nebula", "Night Sky", "Pink Daylight", "Morning Glow", "Setting Sun", "Fade Blue", "Elegant Morning", "Neptune", "Redshift", "Aesthetic Night", "Gloomy Gray", "Light Within Dark", "Green Space", "The Winter", "Oblivion", "Final Bloodmoon", "Clouds", "Twilight", "Red Mountain", "Cloudy Skies", "Dark Blue", "Vaporwave", "Anime Sky", "Retrowave", "Cyberpunk", "Cartoon Day" },
	flag = "skyboxValue",
	callback = function() updateSkybox() end
})
		...
		if library_flags["Airstuck"] then
			...
			if char and hrp then
				if not bool then
					...
					rayParams.FilterDescendantsInstances = {char, workspace:FindFirstChild("Ray_Ignore") or workspace.CurrentCamera}
					local function checkWall(dir) return workspace:Raycast(hrp.Position, dir * 3.5, rayParams) end
					local look, right = hrp.CFrame.LookVector, hrp.CFrame.RightVector
					if checkWall(look) or checkWall(-look) or checkWall(right) or checkWall(-right) then
						hrp.Anchored = true
...
local function updateEdgeBox(pos, active, color)
	...
	if library_flags["Bunny Hop"] and L_57_.alive and not L_54_ then
		...
		if not L_25_:GetFocusedTextBox() and L_1739_ and L_25_:IsKeyDown(Enum.KeyCode.Space) and L_32_.Character:FindFirstChild("Humanoid") then
			...
			if L_25_:IsKeyDown(Enum.KeyCode.A) or L_25_:IsKeyDown(Enum.KeyCode.D) then
				getgenv().bhopSpeed = math.min(getgenv().bhopSpeed + 0.8, baseSpeed + 45)
			elseif isAutoHop and not strafing and getgenv().bhopSpeed > baseSpeed then
			...
			elseif library_flags["Bunny Hop Method"] == "A/D" then
				...
				if speed > (baseSpeed * 2.5) then speed = baseSpeed * 2.5 end
