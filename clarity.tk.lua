...
L_5_.Init = function(self)
	...
	for index, tab in self.tabs do
		...
		if tostring(tab.title):lower() == "skins" then
			...
			env.skinViewportRef = skinViewport
			...
			env.gloveViewportRef = gloveViewport
			...
			env.sleeveViewportRef = sleeveViewport
			...
			loadSleevePreview = function()
				...
				local selected = (team == "CT") and library_flags["skinSleeveCT"] or library_flags["skinSleeveT"]
				local templates = env.SleeveTemplates
			...
			applyWepBtn.Size = UDim2.new(0.48, 0, 1, 0)
			...
			applyGlvBtn.Size = UDim2.new(0.48, 0, 1, 0)
			applyGlvBtn.Position = UDim2.new(0.52, 0, 0, 0)
